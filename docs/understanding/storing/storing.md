...
Here is an example of Composable Graph:
...
```{tip}
We have a [more thorough example of using Chroma](/examples/vector_stores/ChromaIndexDemo.ipynb) if you want to go deeper into this store.
```
